...
const PRODUCTS: Product[] = [
  ...
  {
    id: "honey-melty-conditioner-rosa",
    name: "&Honey Melty Condicionador (Rosa - Avulso)",
    jpName: "&honey メルティ モイストリペア ヘアトリートメント 2.0",
    description: "Tratamento super hidratante de mel que derrete nos fios, controlando o frizz e a umidade.",
    priceBRL: 110.00,
    serviceFeeBRL: 0,
    shippingEstBRL: 45.00,
    image: "cole o link da foto aqui",
