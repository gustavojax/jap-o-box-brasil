...
export default function App() {
  ...
  return (
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <div className="sticky top-0 z-40 w-full bg-white/90 backdrop-blur border-b border-slate-200 shadow-sm">

        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-end">

          <button
            onClick={() => setIsAuthOpen(true)}
            className="bg-slate-900 hover:bg-black text-white px-5 py-2.5 rounded-xl font-bold transition-all shadow-lg"
          >
