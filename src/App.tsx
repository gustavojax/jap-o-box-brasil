  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col pb-20 md:pb-0 font-sans text-slate-900 antialiased">
      ...
      <footer className="w-full bg-white border-t border-slate-200 text-slate-600 pt-12 pb-24 md:pb-12">
        ...
        {/* BANNER DE MEIOS DE PAGAMENTO (ATUALIZADO PAGBANK) */}
        <div className="max-w-4xl mx-auto px-4 mt-10 pt-8 border-t border-slate-100 flex flex-col items-center justify-center space-y-2">
          <p className="text-[10px] font-black tracking-widest text-slate-400 uppercase mb-2">Processamento Seguro Oficial</p>
          <div className="flex items-center justify-center px-8 py-2">
            <img 
              src="https://i.postimg.cc/BnGhZt2L/logo-Pag-Bank-1024x288.png" 
              alt="PagBank" 
