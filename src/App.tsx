              ...
              <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div>
                  ...
                  <div className="text-black space-y-4 text-sm font-bold mb-8">
                    ...
                    <p>Com o nosso serviço de <strong className="text-red-600">Redirecionamento</strong>, você faz compras nos seus sites favoritos como se morasse no Japão usando o nosso endereço.</p>
                    <div className="bg-red-50 border-2 border-red-200 p-4 rounded-xl flex gap-3 text-red-700 mt-6">
                      <Info className="w-5 h-5 flex-shrink-0 mt-0.5" />
                      <p className="text-xs leading-relaxed font-bold"><strong>Como fazer:</strong> Copie o endereço abaixo e cole na hora de finalizar a compra na loja japonesa. Assim que o pagamento chegar, enviamos para você!</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    <div className="bg-white p-5 rounded-2xl border-2 border-red-200 shadow-md hover:border-red-500 transition-all">
                      ...
                      <ul className="space-y-4 text-sm font-bold text-black">
                        <li><a href="https://www.adidas.jp/" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 flex items-center gap-3 group"><ExternalLink className="w-4 h-4 text-red-600 group-hover:scale-110 transition" /> Adidas</a></li>
                        <li><a href="https://www.gu-global.com/" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 flex items-center gap-3 group"><ExternalLink className="w-4 h-4 text-red-600 group-hover:scale-110 transition" /> GU</a></li>
                        <li><a href="https://www.onitsukatiger.com/jp/ja-jp/" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 flex items-center gap-3 group"><ExternalLink className="w-4 h-4 text-red-600 group-hover:scale-110 transition" /> Onitsuka Tiger</a></li>
                        <li><a href="https://www.uniqlo.com/jp/ja/" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 flex items-center gap-3 group"><ExternalLink className="w-4 h-4 text-red-600 group-hover:scale-110 transition" /> Uniqlo</a></li>
                        <li><a href="https://www.nike.com/jp/" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 flex items-center gap-3 group"><ExternalLink className="w-4 h-4 text-red-600 group-hover:scale-110 transition" /> Nike</a></li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-white p-5 rounded-2xl border-2 border-red-200 shadow-md hover:border-red-500 transition-all">
                      ...
                      <ul className="space-y-4 text-sm font-bold text-black">
                        <li><a href="https://www.rakuten.co.jp/" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 flex items-center gap-3 group"><ExternalLink className="w-4 h-4 text-red-600 group-hover:scale-110 transition" /> Rakuten</a></li>
                        <li><a href="https://www.amazon.co.jp/" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 flex items-center gap-3 group"><ExternalLink className="w-4 h-4 text-red-600 group-hover:scale-110 transition" /> Amazon JP</a></li>
                        <li><a href="https://jp.mercari.com/" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 flex items-center gap-3 group"><ExternalLink className="w-4 h-4 text-red-600 group-hover:scale-110 transition" /> Mercari</a></li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-white p-5 rounded-2xl border-2 border-red-200 shadow-md hover:border-red-500 transition-all">
                      ...
                      <ul className="space-y-4 text-sm font-bold text-black">
                        <li><a href="https://www.zara.com/jp/" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 flex items-center gap-3 group"><ExternalLink className="w-4 h-4 text-red-600 group-hover:scale-110 transition" /> Zara</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
